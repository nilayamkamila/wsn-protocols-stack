package com.ssu.wsn.graphics.protocols.cair;
...
import com.ssu.wsn.graphics.protocols.nirm.NIRMProtocolWSNGraphics;
 
public class CAIRProtocolWSNGraphics extends JPanel {
    /*int[] rtra = {
    ...
    int[] cair = {
    		3637,3089,2712,2567,2311,2247,2133,2077,1933,1841,1635,1561,1443,1256,1144,1007,844,739,507,387,241,112,01
    };
    final int PAD = 20;
    ...
    protected void paintComponent(Graphics g) {
        ...
        drawData(g2, cair, Color.blue.darker(), true, "CAIR Lifetime");
	...
	private void drawData(Graphics2D g2, int[] data, Paint paint, boolean isLine, String message) {
        ...
        // Draw lines.
        double xInc = (double)(w - 2*PAD)/(cair.length-1);
        ...
        else if(message.equalsIgnoreCase("CAIR Lifetime")){
        	g2.drawLine((int)(PAD + 7*xInc), (int)(h - PAD - scale*3312), (int)(PAD + 9*xInc), (int)(h - PAD - scale*3312));
            g2.drawString(message, (int)(PAD + 10*xInc), (int)(h - PAD - scale*3312));
        }
        if(isLine){
    ...
    public static void main(String[] args) {
        ...
        f.add(new CAIRProtocolWSNGraphics());
        f.setSize(400,400);
